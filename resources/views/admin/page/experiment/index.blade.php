...
@section('title', 'Nümunədə aparılacaq sınaqlar')
@section('content')
    <!-- Content area -->
    <div class="content">
        <div class="card">
            <div class="card-header bg-transparent header-elements-inline py-0">
                <h6 class="card-title py-3">Nümunədə aparılacaq sınaqlar</h6>
                <div class="header-elements">
                    @can('experiment-create')
                        <a href="{{ route('experiment.create') }}" class="btn btn-success"><i class="icon-plus2"></i> Yeni</a>
                    @endcan
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $('#name, #type, #primary_key').on('keyup change clear', function(){
